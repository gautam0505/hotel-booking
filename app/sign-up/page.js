  ...
  return (
    <div className='flex w-screen h-screen mx-10 p-10'>
      ...
      <div className='w-2/4 h-full p-8 fixed top-0 bottom-0 overflow-y-auto'>
             <h1 className='font-semibold text-5xl my-[40px]'>Welcome To G'Hotel</h1>
             <h5 className='font-light text-gray-500 mt-[-20px]'>Please Register for your account</h5>
        <form onSubmit={handleSubmit} className='mt-10'>
            <span className='flex mb-3'>Username</span>
            <input
            type='text'
          ...
          <span className='flex mt-8 mb-3'>Confirm Password</span>
          <div className='relative'>
            <input
              type={showConfirmPassword ? 'text' : 'password'}
              className={`border-neutral-400 border-[1px] rounded p-3 w-7/12 ${!passwordsMatch && 'border-red-500'}`}
        ...
        <span className=' font-medium text-gray-500 p-20'>Already Have an Account!   <Link href="/sign-in" className='text-teal-600'>Login</Link></span>
